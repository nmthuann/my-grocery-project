...
const Footer = () => {
    return (
        <footer className="bg-slate-200 border-t relative bottom-0 left-0 right-0">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-8 md:py-12">
                {/* Col 1:  */}
                <div className="col-span-1 md:col-span-1 p-4">
                    <h3 className="text-2xl text-blue-900 mb-4 font-bold">
                        Cửa hàng điện thoại di động
                    </h3>
                    <p className="text-justify leading-7 text-blue-900">
                ...
                <div className="p-4">
                    ...
                    <ul className="list-none pb-4">
                        <li className="flex items-center mb-2">
                            ...
                            <p className="text-blue-900 ml-2"> +84 123456789</p>
                        </li>

                        <li className="flex items-center mb-2">
                            <Mail className="text-blue-900" />
                            <p className="text-blue-900 ml-2 ">
