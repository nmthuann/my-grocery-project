...
export const GoogleButton: React.FC<GoogleButtonProps> = ({ option }) => {
    return (
        <Button
            className="bg-gradient-to-r from-blue-700 to-red-700 hover:from-slate-500 hover:to-slate-50 flex w-full justify-center gap-5 rounded px-4 py-4 text-sm font-bold drop-shadow-md "
